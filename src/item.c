...
static const u16 sMachineMoves[] = {
    ...
    MOVE_TRICK_ROOM,         // TM048
    MOVE_LEECH_LIFE,       // TM049
    MOVE_OVERHEAT,         // TM050
    MOVE_ROOST,            // TM051
    ...
    MOVE_FLAME_CHARGE,     // TM077
    MOVE_LOW_SWEEP,        // TM078
